...
helm upgrade --install nginx-ingress -f ./temp/helm/nginx-ingress.yaml stable/nginx-ingress --namespace ingress
helm upgrade --install nginx-ingress-internal -f ./temp/helm/nginx-ingress-internal.yaml stable/nginx-ingress --namespace ingress
